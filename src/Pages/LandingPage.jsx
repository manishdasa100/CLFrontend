    ...
    return <BackgroundWrapper>
        <div className="px-64 pt-10 pb-24 min-h-full ">
            <div id='top-section' className='flex items-center justify-between'>
                ...
                <Button color='primary' variant='bordered'>Sign In</Button>
            </div>
            <div id='hero-section' className='relative h-[700px] flex justify-center items-center -translate-y-9'>
                ...
                <div className='absolute w-[700px] text-center z-50'>
                    ...
                    <p className='mt-8 text-[#aaaaaa] text-lg leading-loose drop-shadow-md'>Acecode helps you crack the code to your coding career by expanding your knowledge and preparing you for technical interviews. Solve challenging problems, and level up your programming skills to ace your next opportunity.</p>
                    <div className='flex justify-center mt-8'>
                        <Button color="primary" variant='solid' size='lg' className='font-semibold shadow-2xl'>Create Account</Button>
                    </div>
                </div>
            </div>
            <div id='features_section' className='flex flex-col items-center backdrop-blur-3xl'>
                <div className='flex justify-between tracking-wide'>
                    <div className='basis-1/2 flex-auto flex flex-col pr-24 border-r-1 border-stroke-gray/10'>
                        ...
                        <p className='text-base text-text-gray mt-7'>Challenge yourself with over 1000 thoughtfully crafted questions on a range of topics. Whether you are a beginner or a seasoned developer you can find problems tailored to your level. </p>
                    ...
                    <div className='basis-1/2 flex flex-auto flex-col pl-24'>
                        ...
                        <p className='text-base text-text-gray mt-7'>Our platform now supports 14 popular coding languages! From Python to Rust, you can now practice and improve your skills in your preferred language. Start coding in your language of choice today. </p>
                ...
                <div className='w-[70%] flex flex-col justify-center items-center text-center mt-28'>
                    ...
                    <p className='text-base text-text-gray mt-7'>Track your progress and monitor your improvement. Your profile becomes a comprehensive showcase of your coding journey, reflecting your growing skills and achievements. </p>
                    <Link isBlock showAnchorIcon href="#" color="primary" className='mt-5 font-semibold w-fit -translate-x-2'>View Your Profile</Link>
                </div>
            </div>
        </div>
        <div id='bottom-section' className='flex flex-col items-center bg-white py-24'>
